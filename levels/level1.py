...
def first_level(player_character):
    ...
    while not cave_explored:
        ...
        choice = input("Do you want to (1) explore the cave or (2) open the chest? ")
        ...
        while chest_opened == False:
            ...
            if chest_opened == True:          
                if not cave_explored:
                    ...
                    print("You come to a fork in the path of the cave. The path on left looks dark and ominous, while the path on the right is dimly lit by glowing fungi.")
                    fork_choice = input("Do you want to go (1) left or (2) right? ")
                    if fork_choice == '1':
